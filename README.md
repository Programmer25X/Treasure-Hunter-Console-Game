...
- **Event-Driven Programming (EDP)**: Used *control structures* to impliment *event listeners*, allowing the state of the game to change according to the player's inputs
- **Memory Management**: 
